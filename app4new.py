...
def get_api_key(use_backup=False):
    ...
    # Primary API key
    primary_key = "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"
    # Backup API key (used when primary key limit is reached)
    backup_key = "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"
...
def get_backup_api_key():
    """Get backup API key"""
    return "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"
